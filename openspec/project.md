...
- **Scripting**: Bash, Zsh
- **Included Tools**:
  - Networking: ping, traceroute, tcpdump, nmap, iptables, iproute2, iftop, iperf3, dhcping, ethtool, conntrack, ipvsadm, mtr, ngrep, socat, tcptraceroute, apache2-utils, bind9-utils, bridge-utils, dnsutils, nftables, openssl, speedtest-cli, whois
  - System Utilities: file, jq, rsync, tree, xz-utils, tar, bzip2, gzip, zstd, zip, unzip, procps, ltrace, strace, pv, expect, parallel, man-db
  - Development: git, gcc, g++, Python3, pip, pipx, Go, Node.js, maven, openjdk-21-jdk, cmake, ccache, gdb, clang, make, valgrind, bear
  - Modern Unix: bat, fd-find, ripgrep, hyperfine, gping
  - VNC: tightvncserver, gnome-session, metacity, nautilus, gnome-terminal, ubuntu-desktop
  - Custom Scripts: `file_compress` (compression utility), `file_split` (file splitting with checksum verification)
...
│       └── install_dev_utils.sh # Installs development utilities
...
├── file_compress          # Custom compression utility
...
- **Image Naming**: nicolaka/netshoot:version (version defined in Makefile)
